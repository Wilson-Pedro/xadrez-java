...
import static xadrez.rules.check.CheckRules.*;
...
//			movimentValid03 = generateRightSideHouses().contains(movimentValid02);
//			movimentValid04 = generateLeftSideHouses().contains(movimentValid01);
//			boolean b1 = movimentValid01 < 64;
//			boolean b2 = movimentValid01 >= 0;
//			boolean b3 = !movimentValid04;
//			boolean b4 = !isSameColor(source, movimentValid01, pieces);
//			boolean isCheck = !isCheck(source, movimentValid01, board, color);
//			if ((movimentValid01 < 64 && movimentValid01 >= 0 && !movimentValid04) && (!isSameColor(source, movimentValid01, pieces) && isCheck))
//				possibleHorseMoves.add(movimentValid01);
//			if (movimentValid02 < 64 && movimentValid02 >= 0 && !movimentValid03 && !isSameColor(source, movimentValid02, pieces))
//				possibleHorseMoves.add(movimentValid02);
//		}
